...
/**
 * Dials entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "dials")
public class Dials{
	...
	@Column(name = "PHONE_CODE", length = 64)
	...
	@Column(name = "MAX_BAUD")
	public Integer getMaxBaud() {
		return this.maxBaud;
	}

	public void setMaxBaud(Integer maxBaud) {
	...
	@Column(name = "COMM_TIME_TAG", nullable = false, length = 19)
